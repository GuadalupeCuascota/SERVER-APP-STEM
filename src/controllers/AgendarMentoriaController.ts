...
class AngerdarMentoriaController {
  ...
  public async list(req: Request, res: Response) {
    ...
    await pool.query(
      "select a.id_agendamiento_mentoria, r.fecha,r.hora_inicio,r.hora_fin,a.id_usuario,u.nombre,u.apellido,u.correo_electronico,t.nombre_estado_agen_mentoria,a.id_registro_mentoria ,a.id_estado_agen_mentoria, r.id_materia , m.nombre_materia, tm.nombre_tema from tipo_estado_agend_mentoria t,registro_mentoria r, agendamiento_mentorias a, usuario u, materia m , tema_materia tm where r.id_registro_mentoria=a.id_registro_mentoria and u.id_usuario=r.id_usuario and  tm.id_tema_materia=r.id_tema_materia and t.id_estado_agen_mentoria=a.id_estado_agen_mentoria and m.id_materia=r.id_materia and r.fecha>=CURDATE()",
      (err: any, rows: any) => {
        if (err) {

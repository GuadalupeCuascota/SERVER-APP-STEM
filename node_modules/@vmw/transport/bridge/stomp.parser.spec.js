...
describe('Stomp Parser [stomp.parser]', () => {
    ...
    it('We should be able to correctly marshall a STOMP message', () => {
        let message1 = StompParser.marshal(StompClient.STOMP_CONNECT, { 'test-header': 'hello', 'some-value': 1234 }, 'stompy is a friend of stampy the elephant');
        let message2 = StompParser.marshal(StompClient.STOMP_MESSAGE, { 'test-header': 'hello', 'some-value': 1234 }, 'hey hey hey!');
        let message3 = StompParser.marshal(StompClient.STOMP_MESSAGE, { 'test-header': 'hello', 'some-value': 1234 }, { look: 'an-object', with: 'properties' });
    ...
    it('We should be able to extract bus commands from a bus message', () => {
        ...
        let busCommand = StompParser.generateStompBusCommand(StompClient.STOMP_CONNECT, id);
    ...
    it('We should be able to extract a stomp message from a bus command message', () => {
        ...
        let busCommand = StompParser.generateStompBusCommand(StompClient.STOMP_CONNECT, id, 'somewhere', stompMessage);
    ...
    it('Check a subscription can be converted to a channel', () => {
        ...
        // private channel
        const subB = StompParser.convertSubscriptionToChannel('puppy/kitty', 'puppy');
        expect(subB).toEqual('kitty');
    });
});
//# sourceMappingURL=stomp.parser.spec.js.map
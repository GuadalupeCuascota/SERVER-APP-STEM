...
export declare const GLOBAL: Window & typeof globalThis;
...
export declare type ProxyControl = IFrameProxyControl;
/**
 * Proxy Controls are special messages that facilitate bus operations for the proxy.
 */
export declare enum ProxyControlType {
 ...
 */
export declare class BusProxyMessage {
    from: string;
    payload: any;
    channel: ChannelName;
    type: MessageType;
    control: ProxyControlType;
    constructor(payload: any, channel: ChannelName, type: MessageType, from?: string);
}
/**

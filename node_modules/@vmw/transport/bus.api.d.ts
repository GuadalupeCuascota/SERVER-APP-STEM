...
export declare type SentFrom = string;
export declare const ORG_ID = "orgId";
export declare const ORGS = "orgs";
...
export interface MessageHandler<T = any, E = any> {
     ...
     * @param successHandler handle success responses
...
export interface MessageResponder<T = any, E = any> {
     ...
     */
    generate(generateSuccessResponse: MessageFunction<T>, generateErrorResponse?: MessageFunction<E>): Subscription;
    /**
...
export declare abstract class EventBus {
     ...
     */
    abstract sendRequestMessageWithId<R>(cname: ChannelName, payload: R, id: UUID, from?: SentFrom, proxyBroadcast?: boolean): void;
    /**
     * Send a command payload to a channel with a supplied ID in the command
     *
     * @param {ChannelName} cname channel to send the payload to
     ...
     * @param proxyBroadcast optional flag, only required when messages originated in another bus.
     */
    abstract sendRequestMessageWithIdAndVersion<R>(cname: ChannelName, payload: R, id: UUID, version: number, from?: SentFrom, proxyBroadcast?: boolean): void;
    /**
     ...
     * @param proxyBroadcast optional flag, only required when messages originated in another bus.
     */
    abstract sendResponseMessageWithId<R>(cname: ChannelName, payload: R, id: UUID, from?: SentFrom, proxyBroadcast?: boolean): void;
    /**
     * Send a response payload to a channel with a supplied ID in the response.
     * @param {ChannelName} cname the channel name to send the response payload to
     * @param {R} payload the payload you want to send in response
     ...
     * @param proxyBroadcast optional flag, only required when messages originated in another bus.
     */
    abstract sendResponseMessageWithIdAndVersion<R>(cname: ChannelName, payload: R, id: UUID, version: number, from?: SentFrom, proxyBroadcast?: boolean): void;
    /**
     ...
     */
    abstract sendErrorMessageWithId<E>(cname: ChannelName, payload: E, id: UUID, from?: SentFrom, proxyBroadcast?: boolean): void;
    /**
     ...
     * @param {boolean} proxyBroadcast rebroadCasted message from proxy?
     */
    abstract sendErrorMessageWithIdAndVersion<E>(cname: ChannelName, payload: E, id: UUID, version: number, from?: SentFrom, proxyBroadcast?: boolean): void;
    /**
     ...
     */
    abstract respondOnce<T>(sendChannel: ChannelName, returnChannel?: ChannelName, from?: SentFrom): MessageResponder<T>;
    /**
     ...
     * @returns {MessageResponder<T>} reference to MessageResponder, generate() function returns response payload.
     */
    abstract respondStream<T>(sendChannel: ChannelName, returnChannel?: ChannelName, from?: SentFrom): MessageResponder<T>;
    /**
     ...
     */
    abstract requestStream<T, R>(sendChannel: ChannelName, requestPayload: T, returnChannel?: ChannelName, from?: SentFrom): MessageHandler<R>;
    /**
     ...
     */
    abstract requestStreamWithId<T, R>(uuid: UUID, sendChannel: ChannelName, requestPayload: T, returnChannel?: ChannelName, from?: SentFrom): MessageHandler<R>;
    /**
     ...
     */
    abstract requestOnce<T, R>(sendChannel: ChannelName, requestPayload: T, returnChannel?: ChannelName, from?: SentFrom): MessageHandler<R>;
    /**
     ...
     */
    abstract requestOnceWithId<T, R>(uuid: UUID, sendChannel: ChannelName, requestPayload: T, returnChannel?: ChannelName, from?: SentFrom): MessageHandler<R>;
    /**
     ...
     */
    abstract listenGalacticStream<R>(cname: ChannelName, from?: SentFrom, galacticConfig?: ChannelBrokerMapping): MessageHandler<R>;
    /**

...
class MateriasCarreraController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // res.json(roles);
            yield database_1.default.query("SELECT m.nombre_materia, c.nombre_carrera from materia m, carreras_fica c , materia_carrera mc where mc.id_materia=m.id_materia and mc.id_carrera=c.id_carrera", (err, rows) => {
                if (err) {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield database_1.default.query(query, [nombre_materia, nombre_carrera]);

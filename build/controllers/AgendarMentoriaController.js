...
class AngerdarMentoriaController {
    ...
    listsolicitudesPorRegistro(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { id } = req.params;
            const solicitudesPorRegistroMentoria = yield database_1.default.query("select a.id_agendamiento_mentoria ,r.fecha,r.hora_inicio,r.hora_fin,r.id_usuario,u.nombre,u.apellido,u.correo_electronico,t.nombre_estado_agen_mentoria,m.nombre_materia, m.id_materia from tipo_estado_agend_mentoria t, registro_mentoria r, agendamiento_mentorias a, usuario u, materia m where r.id_registro_mentoria=a.id_registro_mentoria and u.id_usuario=a.id_usuario and t.id_estado_agen_mentoria=a.id_estado_agen_mentoria and m.id_materia=r.id_materia and r.id_registro_mentoria=?", [id]);
